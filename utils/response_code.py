...
def resp_401() -> Response:
    return JSONResponse(
        ...
        content={'code': 401, 'message': "Authentication failed", 'data': '认证失败',},
    )
...
def resp_422(data: str) -> Response:
    return JSONResponse(
        ...
        content={"errors": [{"loc": [], "msg": data, "type": "value_error"}]},
    )
...
def resp_404(data: str = None) -> Response:
    return ORJSONResponse(
        ...
        content={'code': 404, 'message': "Page Not Found", 'data': data,},
    )
...
def resp_500(data: str = None) -> Response:
    return ORJSONResponse(
        ...
        content={'code': "500", 'message': "Server internal error", 'data': data,},
    )
...
def resp_5000(data: Union[list, dict, str]) -> Response:
    return JSONResponse(
        ...
        content={'code': 5000, 'message': "Token failure", 'data': data,},
    )
